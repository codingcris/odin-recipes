  ...
  [2],
  {
    ...
    161: function (t, e, n) {
      ...
      t.exports = function (t) {
        t.params({ partner: { fallback: u(c.val, c, "partner") } }),
          ...
          t.define("scribeInteraction", function (t, e, n) {
            ...
            return (
              (r.action = t.type),
              "url" === r.element &&
                (r.element = a.clickEventElement(t.target)),
              this.scribe(r, e, n)
            );
          });
      };
    ...
    181: function (t, e, n) {
      ...
      t.exports = a.couple(n(161), n(166), function (t) {
        t.params({
          ...
          size: { fallback: "medium", transform: g },
          showScreenName: { fallback: !0 },
          showCount: { fallback: !0 },
          partner: { fallback: l(s.val, s, "partner") },
          count: {},
          preview: {},
        }),
          t.define("getUrlParams", function () {
            ...
            return u.compact({
              ...
              show_count:
                !t && "none" !== this.params.count && this.params.showCount,
          ...
          t.around("widgetDataAttributes", function (t) {
            return u.aug({ "screen-name": this.params.screenName }, t());
          }),
          t.around("scribeNamespace", function (t) {
            return u.aug(t(), { page: "button", section: "follow" });
          }),
            ...
            this.scribe(
              { action: "impression" },
              {
                ...
                message:
                  [
                    this.params.size,
                    "none" === this.params.count ? "nocount" : "withcount",
                  ].join(":") + ":",
              }
            );
          }),
          t.override("render", function () {
            var t = o(f, { lang: this.params.lang }),
              e = c.encode(this.getUrlParams()),
              n = h.resourceBaseUrl + t + "#" + e;
            return (
              this.scribeImpression(),
              r.all([
                this.sandbox.setTitle(m),
                this.sandbox.addClass(d),
                this.sandbox.loadDocument(n),
              ])
            );
          });
      });
    ...
    199: function (t, e, n) {
      ...
      t.exports = f.couple(n(161), n(166), function (t) {
        t.params({
          lang: { required: !0, transform: g.matchLanguage, fallback: "en" },
          size: { fallback: "medium", transform: k },
          type: { fallback: "share", validate: N },
          text: { transform: S },
          screenName: { transform: p.screenName },
          buttonHashtag: { transform: z },
          partner: { fallback: m(i.val, i, "partner") },
          via: {},
          related: {},
          hashtags: {},
          url: {},
          ...
          t.around("widgetDataAttributes", function (t) {
            return "mention" == this.params.type
              ? l.aug({ "screen-name": this.params.screenName }, t())
              : "hashtag" == this.params.type
              ? l.aug({ hashtag: this.params.buttonHashtag }, t())
              : l.aug({ url: this.params.url }, t());
          }),
          t.around("scribeNamespace", function (t) {
            return l.aug(t(), { page: "button", section: this.params.type });
          }),
          t.define("scribeImpression", function () {
            this.scribe(
              { action: "impression" },
          ...
          t.override("render", function () {
            ...
            return (
              this.scribeImpression(),
              r.all([
                this.sandbox.setTitle(w),
                this.sandbox.addClass(v),
                this.sandbox.addClass(t),
                this.sandbox.loadDocument(a),
              ])
            );
          });
      });
