        ...
        var f = k(),
          g = function (d) {
            m.has(d) ||
              ...
              f.satisfyPersistentDependency(l(d, e));
          };
        for (d of d) g(d);
      };
      return a;
...
__d(
  ...
  function (a, b, c, d, e, f, g, h) {
    ...
    function C(a) {
      ...
      for (a of a) {
        ...
        for (b of [
          ...
          var c;
          for (c of b) if (!s.has(c)) return !1;
        }
      }
      return !0;
    }
    ...
    function E(a) {
      var b = D(a);
      b.be && (delete b.be, Y.done(d("ResourceHasher").getAsyncHash(a)));
    }
    function F(a) {
      var b = s.get(a);
      if (!b)
    ...
    function O(a, b, e) {
      ...
      switch (b.type) {
        ...
        case "css":
          ...
          c("CSSLoader").loadStyleSheet(a, b.src, e, !b.nc, f, M(a, b, f));
          break;
        case "async":
    ...
    function P(a, c, e, f) {
      ...
      for (a of U(a)) {
        ...
        switch (m.type) {
          case "css":
            o = m.nonblocking ? "nonblocking" : "blocking";
            break;
          case "js":
            o = "default";
            break;
          case "async":
            o = m.blocking ? "blocking" : "nonblocking";
            break;
          default:
            m.type, h(0, 3721);
        }
        ...
        var p = A.rsrcDone(l);
        k.push(p);
        o !== "nonblocking" && (j.push(p), o === "blocking" && f.push(p));
        n.has(l) || g.set(l, m);
      }
      var q, r;
      !b("cr:696703")
        ...
        : ((r = b("cr:696703").scheduleLoggingPriCallback),
          (q =
            b(
              "cr:696703"
    ...
    function Q(a, b, e) {
      ...
      var f = b.p;
      if (f)
        for (f of d("CSRIndexUtil").parseCSRIndexes(f)) {
          if (f === d("CSRIndexUtil").UNKNOWN_RESOURCE_INDEX) continue;
          (!t.has(f) || e) && t.set(f, a);
    ...
    function U(a) {
      ...
      for (var e of a) {
        ...
        var g = void 0;
        if (f.type === "csr") g = d("CSRIndexUtil").parseCSRIndexes(f.src);
        else if (f.p)
          (g = d("CSRIndexUtil").parseCSRIndexes(f.p)),
            g.includes(d("CSRIndexUtil").UNKNOWN_RESOURCE_INDEX) && b.set(e, f),
    ...
    var Y = {
      loadModules: function (a, b, f) {
        ...
        if (o) {
          ...
          for (var p of g)
            k.add(A.beDone(p)),
              k.add(A.tierThree(p)),
              k.add(A.tierOneLog(p)),
              k.add(A.tierTwoLog(p)),
              k.add(A.tierThreeLog(p));
          A.registerCallback(function () {
      ...
      beDone: function (a, b, c) {
        for (d of (d = (d = v.get(a)) == null ? void 0 : d.logData) != null
          ? d
          : []) {
          var d;
      ...
      handlePayload: function (a, b) {
        ...
        e =
          a.csrUpgrade != null
            ...
            : [];
        var f = e.find(function (a) {
          return !t.has(a);
        });
        e.length && a.consistency.rev !== c("SiteData").client_revision
          ...
          : e.forEach(d("CSRBitMap").add);
        a.compMap && Y.enableBootload(a.compMap, b);
      },
      ...
      markComponentsAsImmediate: function (a) {
        for (a of a) q.has(a) ? E(a) : j.add(a);
      },
      ...
      loadPredictedResourceMap: function (a, b, c) {
        Y.setResourceMap(a, null, c), Y.loadResources(Object.keys(a), b);
      },
    ...
    c("JSResourceReferenceImpl").setBootloader(Y);
    f = Y;
    g["default"] = f;
  },
  98
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function a(a, b) {
      ...
      var f = babelHelpers["extends"](
        {},
        d("asyncParams").get(),
        ((e = { __user: c("CurrentUserInitialData").USER_ID, __a: 1 }),
        (e[c("StaticSiteData").jsmod_key] = b
          ? null
          : c("ServerJSDefine").getLoadedModuleHash()),
        (e[c("StaticSiteData").csr_key] = b
          ? null
          : d("CSRBitMap").toCompressedString()),
        (e.__req = c("uniqueRequestID")()),
      ...
      if (!c("SiteData").wbloks_env) {
        f[c("StaticSiteData").comet_key] =
          (b = c("SiteData").comet_env) != null
            ? b
            : c("SiteData").is_comet
            ? 1
            : 0;
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    "use strict";
    var h = c("requireDeferred")("BanzaiScuba_DEPRECATED").__setRef(
        "CookieStore"
      ),
      i =
      ...
      b.getCookie = function (a) {
        ...
        b =
          (b = n()) == null
            ? void 0
            : b.match("(?:^|;\\s*)" + a + "=(.*?)(?:;|$)");
        a = c("performanceNow")() - d;
        d = 1 / c("CookieCoreLoggingConfig").sampleRateClassic;
        var e = c("Random").coinflip(d);
    ...
    var q = 10 * 1e3,
      r = (function () {
        ...
        b.getCookie = function (a) {
          ...
          var d = a.cookie;
          a = a.hit;
          var e = 1 / c("CookieCoreLoggingConfig").sampleRateFastStale,
            f = c("Random").coinflip(e);
          if (f) {
            f = c("performanceNow")() - b;
    ...
    function a() {
      return c("gkx")("676837") ? new r() : new o();
    }
    g.newCookieStore = a;
    g.CookieCacheForTest = r;
  ...
  function (a, b, c, d, e, f, g) {
    ...
    f = {
      ...
      setWithoutChecksIfFirstPartyContext:
        d("CookieCore").setWithoutChecksIfFirstPartyContext,
    };
    g["default"] = f;
  },
  98
    ...
    a = {
      setDirection: function (a, c, d) {
        ...
        if (!f || d) {
          ...
          e.length === 0 &&
            (b("Style").set(a, "direction", ""), a.removeAttribute("dir"));
      },
    };
    e.exports = a;
  },
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    c("Event").listen(document.documentElement, { keyup: a, input: a });
  },
  34
);
__d(
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function s(a, b) {
      ...
      b = b.c;
      b != null &&
        c("AnalyticsCoreData").consents != null &&
        (d = d && t(b, c("AnalyticsCoreData").consents, a));
      return d;
    }
    function t(a, b, d) {
      var e = r[a];
...
__d(
  ...
  [],
  function (a, b, c, d, e, f) {
    var g = typeof window !== "undefined" && window != window.top;
    function a() {
      return g;
    }
    f["default"] = a;
    ...
    a = (function () {
      ...
      c.$13 = (function () {
        var a = b("asyncToGeneratorRuntime").asyncToGenerator(function* () {
          ...
          this.$4 = b;
          b && this.$8();
          return a ? this.$10().decode(a, { stream: !b }) : "";
        });
        function c() {
          return a.apply(this, arguments);
        }
...
__d(
  "getAsyncHeaders",
  ["BDHeaderConfig", "LSD", "ZeroCategoryHeader", "gkx", "isFacebookURI"],
  function (a, b, c, d, e, f, g) {
    function a(a) {
      var b = {},
        d = c("isFacebookURI")(a);
      ...
      AsyncRequest = (function () {
        ...
        _proto._handleJSRegisters = function _handleJSRegisters(
          ...
          if (registers)
            for (var ii = 0; ii < registers.length; ii++) {
              var caller = null,
                script = registers[ii],
                matches = script.match(/^\"caller:([^\"]+?)\";(.*)/);
              matches != null && ((caller = matches[1]), (script = matches[2]));
              importDefault("ErrorGuard").applyWithGuard(
                new Function(script),
                this,
                []
              );
              importDefault("FBLogger")("comet_infra").info(
        ...
        _proto.invokeResponseHandler = function invokeResponseHandler(
          ...
          if (interpreted.bootloadOnly !== void 0) {
            ...
            for (var rsrcs of toBootload) _loop(rsrcs);
            return;
          }
          if (
            !this.handler &&
          ...
          if (typeof response !== "undefined") {
            ...
            response.updateScriptPath &&
              importDefault("ScriptPath").set(
                response.updateScriptPath.path,
                response.updateScriptPath.token,
                response.updateScriptPath.extra_info
              );
            response.lid &&
        ...
        _proto._displayServerLegacyDialog = function _displayServerLegacyDialog(
          ...
          if (importDefault("gkx")("708253")) {
            var _ref, _async_response$reque;
        ...
        _proto._setJSONPTransport = function _setJSONPTransport(transport) {
        ...
        _proto.setURI = function setURI(uri, throwOnInvalid) {
          ...
          if (
            ...
            !importDefault("uriIsRelativePath")(uri_obj)
          ) {
        ...
        _proto._addStatusIndicator = function _addStatusIndicator() {
          var statusElem = this.getStatusElement();
          statusElem &&
        ...
        _proto.send = function send(isRetry) {
          ...
          if (this.getOption("useFetchWithIframeFallback"))
            try {
              ...
              this._setJSONPTransport(_transport);
          ...
          if (this.getOption("useIframeTransport")) {
            requireLazy(["JSONPTransport"], function (JSONPTransport) {
              var transport = new JSONPTransport(_this11.uri);
              _this11._setJSONPTransport(transport);
          ...
          if (
            ...
            !importDefault("uriIsRelativePath")(this.uri) &&
            !this.getOption("useIframeTransport") &&
            !this.getOption("useFetchWithIframeFallback")
          ) {
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    var h = {
      ...
      i = (function () {
        function a(a, b) {
          (this.return_params = c("URI").getRequestURI().getQueryData()),
            (this.login_params = {}),
            (this.optin_params = {}),
            (this.plugin = a),
            (this.api_key = b),
        ...
        b.start = function () {
          ...
          c("URI").getRequestURI().getQueryData().kid_directed_site &&
...
__d(
  "PluginConnectButtonResize",
  ["DOMDimensions", "DOMQuery", "PluginResize", "Style", "getElementPosition"],
  function (a, b, c, d, e, f) {
    function a(a, c, d) {
      ...
      function e() {
        ...
        return { x: c.x + a.width, y: c.y + a.height };
      }
      new (b("PluginResize"))(
        function () {
          return Math.max(
            b("PluginResize").getElementWidth(a),
            c && c.offsetWidth,
            e().x
          );
        },
        function () {
          return Math.max(
            a.offsetHeight,
            c ? c.offsetHeight + c.offsetTop : 0,
            e().y
          );
        },
        "resize.iframe",
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    a = (function () {
      function a(a, b) {
        (this.$1 = c("URI").getRequestURI().getQueryData()),
          (this.$2 = a),
          (this.$3 = b),
          this.addReturnParams({ ret: "consent" }),
          delete this.$1.hash;
      }
      var b = a.prototype;
      b.addReturnParams = function (a) {
      ...
      b.start = function () {
        var a =
            this.$3 || (this.$2 === "like" ? 107599262613689 : 105440539523),
        ...
        d("UserAgent_DEPRECATED").mobile()
          ? b.setSubdomain("m")
          : b.addQueryData({ display: "popup" });
        ...
        if (!b) {
          if (c("sdk.feature")("popup_blocker_scribe_logging", !0)) {
            ...
            d("sdk.Scribe").log("jssdk_error", {
              appId: a,
              error: b,
              extra: { message: "plugin_cookie_consent" },
            });
          }
          return this;
        }
...
__d(
  "PluginConnectButtonWrapIconButton",
  [
    "Arbiter",
    "DOM",
    "Event",
    ...
    var h = {
      ...
      initializeButton: function (a, b, e, f, g, i, j, k, l, m, n, o) {
        (h._connected = e),
          ...
          (h._button = b),
          (h._plugin = j),
          (h._submitRequest = null),
          (h._connecttip = l),
          (h._disconnecttip = m),
          (h._shouldConfirm = n),
          f
            ? (c("Event").listen(a, "click", function (a) {
              ...
              c("Arbiter").subscribe(
                d("Plugin").CONNECT,
                h._updatePlugin.bind(h)
              ),
              c("Arbiter").subscribe(
                d("Plugin").DISCONNECT,
                h._updatePlugin.bind(h)
              ),
              c("Arbiter").subscribe(d("Plugin").ERROR, function (a, b) {
            ...
            ? d("PluginDOMEventListener").add(h._form, "click", function (a) {
                ...
                new (d("PluginConsent").PluginConsent)(j, a)
                  .addReturnParams({ act: "connect" })
                  .start();
              })
            : d("PluginDOMEventListener").add(h._form, "click", function (a) {
                a.preventDefault(),
                  new (c("PluginOptin"))(
                    j,
                    c("URI").getRequestURI().getQueryData().api_key
                  )
                    .addReturnParams({ act: "connect" })
                    .addLoginParams({ social_plugin_action: k })
                    .start();
              });
      },
      submit: function () {
        h._submitRequest !== null &&
          (h._submitRequest.clearStatusIndicator(), h._submitRequest.abort()),
          (h._submitRequest = c("FormSubmit").send(h._form)),
          h._connected
            ? d("Plugin").disconnect(h._href)
            : d("Plugin").connect(h._href);
      },
      ...
      _toggleFormAction: function () {
        var a =
          d("PlatformWidgetEndpoint").plugins(h._plugin) +
          "/" +
          (h._connected ? "disconnect" : "connect");
...
__d(
  ...
  function (a, b, c, d, e, f) {
    ...
    function a(a) {
      var b =
        a.connected.textContent.length - a.disconnected.textContent.length;
      a[b > 0 ? "disconnected" : "connected"].appendChild(
        document.createTextNode("\xa0".repeat(Math.abs(b)))
      );
    }
    f.init = a;
  },
  ...
  function (a, b, c, d, e, f, g) {
    a = (function () {
      ...
      b.init = function (a, b, e, f) {
        ...
        this.css = e;
        c("Arbiter").subscribe(
          [d("Plugin").CONNECT, d("Plugin").DISCONNECT],
          function (c, g) {
            a === g.href &&
              d("CSS")[c === f ? "addClass" : "removeClass"](b, e);
            return !0;
          }
        );
        return this;
          ...
          c("ErrorSetup").setup(
            {
              ...
              loggingFramework:
                c("SiteData").haste_site === "mobile" ? "mobile" : "blue",
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function H(a, b) {
      O(b.item.name, "js.br.add_to_batch", 1, !0);
    ...
    function I() {
      ...
      if (!C) {
        N("js.br.init_not_complete.log", a.length);
        var b = function () {
          var b = a[c],
            d = b[0],
            e = b[1];
          O(e.item.name, "js.br.banzai_fallback_for_init_not_complete", 1, !0);
          ((b = e.item.logImmediate) != null ? b : !1)
            ? P.logImmediately([e.item], function (a) {
                return d.markItem(e, a);
              })
            : P.log([e.item], function (a) {
                return d.markItem(e, a);
              });
        };
        ...
        m.enqueue(function (b) {
          return b.log(
            ...
            function (b) {
              if (!b) {
                N("js.br.banzai_fallback", a.length);
                var c = function () {
                  var c = a[d],
                    b = c[0],
                    e = c[1];
                  O(e.item.name, "js.br.banzai_fallback_for_failure", 1, !0);
    ...
    function L(a, b) {
      for (var e = 0; e < a.length; e++) {
        var f,
          g = a[e];
        O(g.name, "js.banzai.posting_event", 1, !1);
        f =
          ((f = {}),
          (f.e = g.extra),
          (f.r = g.policy.r),
      ...
      M("planes.banzai.write_to_transport", a);
    }
    function M(a, b) {
      var c = 0;
      for (var d = 0; d < b.length; d++) {
    ...
    var P = {
      log: function (a, b) {
        M("js.banzai.post.log", a), L(a, c("Banzai").BASIC), b(!0);
      },
      logImmediately: function (a, b) {
        M("js.banzai.post.log_immediately", a), L(a, c("Banzai").VITAL), b(!0);
      },
      logCritical: function (a, b) {
        M("js.banzai.post.log_critical", a),
          L(a, { signal: !0, retry: !0 }),
          b(!0);
      },
    };
    function Q(a) {
      V();
      var b = R(a, "banzai_data_loss", "log"),
        d = R(a, "banzai_data_loss", "logImmediately"),
        e = R(a, "banzai_data_loss", "logCritical"),
        f = R(a, "bladerunner_data_loss", "");
      N("js.br_data_loss.posted." + a, 1);
      if (C && B)
        try {
          m.enqueue(function (b) {
            return b.log([f], function (b) {
              if (!b) {
                N("js.br.transport_failure." + a, 1);
                P.logCritical([f], function (b) {
                  N("js.br.failure_fallback_success_callback." + a, 1);
                });
                return;
              }
              N("js.br.success_callback." + a, 1);
            });
          });
        } catch (b) {
          N("js.br.error_enqueueing." + a, 1),
            P.logCritical([f], function (b) {
              N("js.br.enqueuing_fallback_success_callback." + a, 1);
            });
        }
      else
        B || N("js.br.failed." + a, 1),
          C || N("js.br.init_not_complete." + a, 1),
          P.logCritical([f], function (b) {
            N("js.br.init_fallback_success_callback." + a, 1);
          });
      L([b], c("Banzai").BASIC);
      L([d], c("Banzai").VITAL);
      L([e], { signal: !0, retry: !0 });
    }
    function R(a, b, d) {
      return {
        name: b,
    ...
    function U(a) {
      m.start(function (b) {
        return b({
          log: function (d, b) {
            M("planes.bladerunner.write_to_transport", d);
            ...
            a
              ? c("AnalyticsCoreData").enable_ack
                ? c("promiseDone")(
                    a.amendWithAck(e),
                    function (a) {
                      M("planes.bladerunner.ack_received" + a.toString(), d),
                        b(a);
                    },
                    function () {
                      M("planes.bladerunner.ack_failure", d), b(!1);
                    }
                  )
                : (a.amendWithoutAck(e),
                  M("planes.bladerunner.write_without_ack", d))
              : (M("planes.bladerunner.request_stream_null", d), b(!1));
          },
    ...
    function W(a) {
      ...
      if (!G() || !B) {
        u !== 1 &&
          O(b, "js.use_bladerunner.failed.non_fb_event.br_not_enabled", 1, !0);
        return !1;
      }
      if (s.has(b)) {
        a.shouldAddState = !0;
      ...
      if (u !== 1 && !t.has(b)) {
        O(b, "js.use_bladerunner.failed.non_fb_event.event_not_in_list", 1, !0);
        return !1;
      }
      a.policy.s !== 1 &&
        u !== 1 &&
    ...
    function a() {
      ...
      c("PersistedQueue").setHandler("falco_queue_log", function (a) {
        var b,
          c = X(a.getQueueNameSuffix());
        while ((b = a.dequeueItem()))
          (function (b) {
            W(b.item)
              ? (O(b.item.name, "js.use_bladerunner.log", 1, !0),
                V(),
                x == null && (x = setTimeout(I, j)),
                H(a, b))
              : (O(b.item.name, "js.use_banzai.log", 1, !0),
                c && (b.item.identity = c),
                P.log([b.item], function (c) {
      ...
      c("PersistedQueue").setHandler("falco_queue_immediately", function (a) {
        var b,
          d = X(a.getQueueNameSuffix());
        while ((b = a.dequeueItem()))
          (function (b) {
            W(b.item)
              ? (O(b.item.name, "js.use_bladerunner.log_immediately", 1, !0),
                V(),
                (x == null || !y) &&
                ...
                c("PersistedQueue").isPersistenceAllowed() ||
                  ...
                  I()))
              : (O(b.item.name, "js.use_banzai.log_immediately", 1, !0),
                d && (b.item.identity = d),
                P.logImmediately([b.item], function (c) {
                  return a.markItem(b, c);
                }));
          })(b);
      });
      c("PersistedQueue").setHandler("falco_queue_critical", function (a) {
        ...
        while ((b = a.dequeueItem()))
          (function (b) {
            var d = b.item;
            W(d)
              ? (O(d.name, "js.use_bladerunner.log_critical", 1, !0),
                V(),
                !C
                  ? (O(d.name, "js.br.init_not_complete.logCritical", 1, !0),
                    c && (d.identity = c),
                    P.logCritical([d], function (c) {
                      return a.markItem(b, c);
                    }))
                  : m.enqueue(function (e) {
                      return e.logCritical([d], function (e) {
                        if (!e) {
                          N("js.br.banzai_fallback.critical", 1);
                          O(
                            b.item.name,
              ...
              : (c && (d.identity = c),
                O(d.name, "js.use_banzai.log_critical", 1, !0),
                P.logCritical([d], function (c) {
                  return a.markItem(b, c);
                }));
          })(b);
      });
      c("AnalyticsCoreData").enable_dataloss_timer && (V(), S(), T());
    }
    g.attach = a;
  },
  98
    ...
    var h = 1e4,
      ...
      m = {
        ...
        log: function (a) {
          ...
          d = d + "|" + String(a);
          k[d] == null
            ? ((k[d] = i()), k[d].s.add(c), (l += 1))
            : k[d].s.has(c)
            ? (k[d].s["delete"](c), (k[d].h[c] = 2))
            : k[d].h[c] != null
            ? (k[d].h[c] += 1)
            : (k[d].s.add(c), (l += 1));
          l === 1 &&
            m.postTimeout == null &&
            b("ExecutionEnvironment").canUseDOM &&
            (m.postTimeout = b("setTimeoutAcrossTransitions")(function () {
              m.postBatch();
            }, h));
          l === m.MAX_BATCH_SIZE &&
...
__d(
  "FbtLoggerImpl",
  ["BanzaiFbtBatchLogger", "ScriptPath"],
  function (a, b, c, d, e, f, g) {
    function a(a) {
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    var t = c("Arbiter").registerCallback(
        function () {
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function a(a, b, d) {
      ...
      h(a, b);
      setTimeout(function () {
        (e.content = c("LinkshimHandlerConfig").default_meta_referrer_policy),
          new (c("AsyncSignal"))(d, {}).send();
      }, 100);
    }
    g.swap = h;
    g.referrer_log = a;
...
__d(
  "PluginQuote",
  ["Arbiter", "DOM", "DOMEventListener", "UnverifiedXD"],
  function (a, b, c, d, e, f, g) {
    "use strict";
    function a(a) {
      d("DOMEventListener").add(a, "click", function () {
        c("UnverifiedXD").send({ type: "getTextSelection" });
      }),
        c("Arbiter").subscribe(
          "Connect.Unsafe.setTextSelection",
          function (b, d) {
            c("DOM").insertAfter(
              a,
              c("DOM").create("input", {
...
__d(
  ...
  function (a, b, c, d, e, f, g, h) {
    function i(a, b, e) {
      ...
      i = c("XRefererFrameControllerRouteBuilder").buildUri({ no_lower: i });
      var j;
      ...
      c("isWorkplaceDotComURI")(c("getRequestConstUri")())
        ...
        ? (j = d("ConstUriUtils").getUri("/intern/common/referer_frame.php"))
        : (j = i);
      e == null &&
        c("isWorkplaceDotComURI")(c("getRequestConstUri")()) &&
        (e = "workplace");
      if (e) {
        j = (i = j) == null ? void 0 : i.addQueryParam("fb_source", e);
      }
      j != null || h(0, 67317);
      a.onload = g;
      a.src = j.toString();
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    var h = new Map(),
      ...
      j = new Map(),
      k = {
        addToQueue: function (a, b, d, e, f, g, i, j) {
          if (c("CookieConsent").hasConsent(1)) {
            f
              ...
              : c("Cookie").setWithoutChecks(a, b, d, e, i, j);
            return;
          }
          if (h.has(a)) return;
          h.set(a, {
        ...
        flushAllCookiesWithoutRecordingConsentDONOTCALLBEFORECONSENT:
          function () {
            ...
            if (
              c("killswitch")("DEFERREDCOOKIE_EMPTY_COOKIES_BEFORE_CALLBACK")
            ) {
              c("CookieConsent").setConsented();
              for (var a of j) a[1].fireCallbacks();
              h.clear();
            } else {
              h.clear();
              c("CookieConsent").setConsented();
              for (a of j) a[1].fireCallbacks();
            }
          },
        flushAllCookiesINTERNALONLY: function (a, d, e, f, g) {
          ...
          var h = { accept_only_essential: f };
          d != null &&
            ((d = Object.fromEntries(d)),
            (h = { optouts: d, accept_only_essential: f }));
          d = c("flattenPHPQueryData")(h);
          if (!i) {
            f = c("CSTXCookieRecordConsentControllerRouteBuilder").buildUri({});
            h = new (c("URLSearchParams"))(location.search).get(
              "ig_3p_controls"
            );
            if (h === "on") {
            ...
            b("cr:1069930") != null
              ? c("promiseDone")(
                  b("cr:1069930")(f.toString(), { data: d, method: "POST" }),
                  function () {
                    return j();
                  },
                  function (a) {
                    b("cr:1083117") &&
                      b("cr:1083117")(
                        "Cookie consent has not been set successfully: " +
                          a.errorMsg,
                        "comet_infra"
                      );
                  }
        ...
        registerCallbackOnCookieFlush: function (a, b) {
          c("CookieConsent").hasConsent(a)
            ? b()
            : (j.has(a) || j.set(a, new (c("SubscriptionList"))()),
              c("nullthrows")(j.get(a)).add(b));
        },
...
__d(
  "TrackingPixel",
  ["Arbiter", "ControlledReferer", "DeferredCookie", "FBLogger"],
  function (a, b, c, d, e, f) {
    var g = {
      _iframe: void 0,
      ...
      loadWithNoReferrer: function (a) {
        if (!b("DeferredCookie").canEmbedThirdPartyPixel()) {
          b("FBLogger")("tracking_pixel").mustfix(
            "Attempting to load a TrackingPixel (%s) while cookies are deferred. This is not allowed because tracking pixels sometimes set cookies.",
            a
          );
          return;
        }
    ...
    c = (function (a) {
      ...
      function c(c, d, e, f, g) {
        ...
        f &&
          ...
          f.subscribe(
            "confirm",
            h._handleDialogConfirm.bind(babelHelpers.assertThisInitialized(h))
          ),
        ...
        b("Event").listen(
          h._root,
          "submit",
          h._handleSubmit.bind(babelHelpers.assertThisInitialized(h))
        );
        g && g.length && h.enableBehaviors(g);
        c = !0;
        b("Run").onBeforeUnload(
          h.checkUnsaved.bind(babelHelpers.assertThisInitialized(h)),
          c
        );
        return h;
      }
